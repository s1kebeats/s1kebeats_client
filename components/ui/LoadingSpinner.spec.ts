...
describe('LoadingSpinner', async () => {
  it('should render with default color and size values', () => {
  ...
  it('should render with "color" prop set to "black" and "size" prop set to "lg"', () => {
    const wrapper = mount(LoadingSpinner, {
      props: {
        color: 'black',
        size: 'lg',
  ...
  it('should render properly with "size" prop set to "sm"', () => {
    const wrapper = mount(LoadingSpinner, {
      props: {
        size: 'sm',
      },
